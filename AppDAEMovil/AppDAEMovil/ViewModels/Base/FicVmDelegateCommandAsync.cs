...
namespace AppJDiegoMovil.ViewModels.Base
{
    ...
    /// </summary>
    public class FicVmDelegateCommandAsync
    {
        ...
        public FicVmDelegateCommandAsync(Func<Task> execute) : this(execute, null)
        {
        ...
        public FicVmDelegateCommandAsync(Func<Task> execute, Func<Task<bool>> canExecute)
        {
            _execute = execute;
