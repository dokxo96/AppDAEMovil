...
namespace AppDAEMovil
{
    public partial class App : Application
    {
        ...
        public App()
        {
            Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense("NDQ1OTZAMzEzNjJlMzMyZTMwaGt5QVZFNzlhYUlhTG5qMkZaQ1pNTkROZ3E5aDdXZFpOeFVXMmNYRlV2RT0 =");

            InitializeComponent();

            //MainPage = new MainPage();
            MainPage = new FicViCatalogoSkuLista();
